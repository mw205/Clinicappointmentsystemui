    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          component: () =>
            import("@/views/receptionist/DoctorSchedulesView.vue"),
        },
        {
          path: "doctor/emr-form",
          name: "doctor-emr-form",
          component: () => import("@/views/doctor/EMRFormView.vue"),
        },
        {
          path: "doctor/records",
          name: "doctor-records",
        ...
        // Receptionist routes
        {
          ...
          component: () =>
            import("@/views/receptionist/QueueManagementView.vue"),
        },
        {
          path: "receptionist/schedules",
          name: "receptionist-schedules",
          component: () =>
            import("@/views/receptionist/DoctorSchedulesView.vue"),
        },
        // Admin routes
